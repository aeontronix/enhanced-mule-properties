...
public class ECfgTestRawExpression extends MuleArtifactFunctionalTestCase {
    @Override
    ...
    @Test
    public void testRawExpression() throws Exception {
        final Map<String, TypedValue<?>> vars = flowRunner("test").run().getVariables();
        assertThat(vars.get("testresult").getValue(), is("thisIsRawExp"));
    }
}
